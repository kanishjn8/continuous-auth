...
export function AlertCard({
  ...
  return (
    <article className={`alert-card ${availability ? "availability" : "behavioral"}`}>
      <div>
        <strong>{availability ? "SYSTEM PROTECTION ALERT" : "BEHAVIORAL RISK ALERT"}</strong>
      ...
      <button disabled={alert.acknowledged} onClick={() => onAcknowledge(alert.alert_id)}>
