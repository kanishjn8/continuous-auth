...
from .application import create_synthetic_development_application
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--synthetic-user", required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    integrated = create_synthetic_development_application(
        local_secret=local_secret,
        synthetic_user_id=arguments.synthetic_user,
        workspace_root=ROOT,
